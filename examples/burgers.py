...
def main():
    ...
    parser.add_argument("--outdir", type=Path, default=Path(__file__).resolve().parent / "outputs" / "png" / "burgers")
    ...
    # Train
    if args.fast:
        epochs, n_collocation = 500, 800
    else:
        epochs, n_collocation = args.epochs, 2000
    ...
    Visualizer.plot_2d(model, pde, resolution=150, save_path=outdir / "solution_2d.png", show=False)
